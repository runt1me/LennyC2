...
## Usage (screenshots)
### Basic metadata will be returned on the initial callback
...
To mitigate a malicious python script, heuristic detection actually needs to be dialed in pretty well. "Out-of-the-box" EDR settings will likely not flag a script like this, so environment-specific tuning will probably be required. Get a baseline of your environment, and know what "different" looks like.
